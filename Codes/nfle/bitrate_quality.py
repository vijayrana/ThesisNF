...
brcmd = 'ffmpeg -y -i {f} -c:v libx265 -x265-params pass=1:stats={fn}/{fn}_{br}M.log -b:v {br}M -preset {ps} -an -f null /dev/null && ffmpeg -y -i {f} -c:v libx265 -x265-params pass=2:stats={fn}/{fn}_{br}M.log $
